		...
		if (objSubscription.channel == 'bank') {
			return (
				<div className="subscribe-cancellation">
					...
					<p>If you are unsubscribing by mistake, and wish to re-subscribe, please turn back to <a href="/subscription">your subscription</a> and continue to enjoy our amazing learning system.</p>
				</div>
			)
		} else {
			return (
