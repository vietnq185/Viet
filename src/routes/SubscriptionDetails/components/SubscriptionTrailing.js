      ...
      <div className='subscribe-details'>
        ...
        <div className='info'>
          <div className='row'>
            ...
            <div className='col-sm-6 col-xs-12'>
              <div>Current period: {moment.unix(objSubscription.dateModified / 1000).format('MMM D, YYYY')} to {moment.unix(objSubscription.expiryDate / 1000).format('MMM D, YYYY')}</div>
