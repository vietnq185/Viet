...
var _APIResponse = require('../server/helpers/APIResponse');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var debug = require('debug')('rest-api:express');
...
app.get('*', function (req, res, next) {
  try {
    ...
    var filepath = _path2.default.join(__dirname, '../web/index.html');
    var content = _fs2.default.readFileSync(filepath, { encoding: 'utf8' });
...
app.use(function (err, req, res, next) {
  return (// eslint-disable-line no-unused-vars
    res.status(err.status).json(new _APIResponse.APIErrorResponse({
